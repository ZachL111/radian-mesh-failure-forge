"""Regression checks for the radian-mesh-failure-forge casebook."""
...
from casebook.harness import assert_expected, radian_mesh_failure_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_mesh_failure_forge_summary(), assert_expected())
