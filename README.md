...
radian-mesh-failure-forge is a SQL project for distributed systems. It focuses on this technical goal: Implement an SQL distributed systems project for failure resource planning, using capacity fixtures and allocation and spill reports.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 156, risk penalty 5, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
